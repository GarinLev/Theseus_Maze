...
class MazeRenderer:
    ...
    def render_full_frame(cls, state, send_cmd_func):
        ...
        if state.level_complete:
            ...
            io = imgui.get_io()
            pos = imgui.ImVec2(io.display_size.x - 150, io.display_size.y - 50)
            color = imgui.get_color_u32(imgui.ImVec4(1.0, 1.0, 0.0, 1.0))
            draw_list.add_text(pos, color, "FINISH")
...
class NetworkController:
    ...
    def main_loop_tick(self):
        if not self.state.level_complete:
