...
namespace robot {
    ...
    void init() {
        ...
        wheelManager.fr = &wheelA1; wheelManager.fl = &wheelB1;
        wheelManager.br = &wheelA2; wheelManager.bl = &wheelB2;
        wheelManager.init();
        ...
        lightController.color = COLORS::mBlue;
        lightController.on();
    ...
    int update_step() {
        ...
        if (current_sub_step == SUB_MOVING) {
            ...
            wheelManager.moveDistance(300.0f, 100.0f, &rotateController.angel.ypr[1]);
